        ...
        <div className={styles.SidebarRight}>
            <div className={styles.wrapper}>
                            ...
                            <div className={styles.searchBar}>
                                <div className={styles.searchBarPill}>
                                    <div className={styles.searchWrapper}>
                                        ...
                                        />
                                        <span
                                            className={`body ${styles.searchLabel}`}
                                        >
                                            Search
                                        </span>
                                    </div>
                        ...
                        >
                            <div className={styles.whatsHappeningModule}>
                                <Transition
                                    ...
                                    animationConfiguration={loaderStyle}
                                    entranceDelay={
                                        1.5 * loaderStyle.delayFactor
                                    }
                                    component={"whatsHappeningLabel"}
                                    entranceOnly={true}
                                >
                                    <h1
                                        className={`headline1 ${styles.whatsHappeningLabel}`}
                                    >
                                        What's happening
                                    </h1>
                                </Transition>
                                ...
                                >
                                    <h4
                                        className={`body ${styles.showMoreLabel}`}
                                    >
                                        Show more
                                    </h4>
                                </Transition>
                ...
                <Transition
                    ...
                    animationConfiguration={loaderStyle}
                    entranceDelay={
                        (1 + whatsHappeningDelay) * loaderStyle.delayFactor
                    }
                ...
                >
                    <div className={styles.whoToFollowModule}>
                        ...
                        <Transition
                            ...
                            entranceOnly={true}
                        >
                            <h4 className={`body ${styles.showMoreLabel}`}>
                                Show more
                            </h4>
                        </Transition>
                    </div>
