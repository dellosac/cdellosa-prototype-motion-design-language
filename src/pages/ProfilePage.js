            ...
            <article className={styles.profilePage}>
                ...
                >
                    <div className={styles.pageHeader}>
                        <StaticItem
                            ...
                            src={"./images/pages/profile/back-cta"}
                        />
                        <div className={styles.pageLabel}>
                            <h1 className={`headline2 ${styles.pageHeadline}`}>
                                First Last
                            </h1>
                            <h2 className={`subtext2 ${styles.pageSubline}`}>
                                7,226 Posts
                            </h2>
                        </div>
                    </div>
                ...
                >
                    <StaticItem
                        ...
                        src={"./images/pages/profile/banner"}
                    />
                </Transition>
                <Transition
                    isActive={true}
                ...
                >
                    <div className={`subtext1 ${styles.editProfileBtn}`}>
                        Edit profile
                    </div>
                </Transition>
                <div className={styles.copyLockup}>
                    ...
                    >
                        <h2 className={`body ${styles.usernameLabel}`}>
                            @username
                        </h2>
                    </Transition>
                    <Transition
                    ...
                    >
                        <div className={`subtext2 ${styles.metaData}`}>
                            <StaticItem
                                ...
                                src={"./images/pages/profile/location-icon"}
                            />
                            ...
                            <span className={styles.linkIcon}>
                                <StaticItem
                                    src={"./images/pages/profile/link-icon"}
                                />
                            </span>
                            <span className={styles.linkLabel}>post.com</span>
                            <span className={styles.dateIcon}>
                                <StaticItem
                                    src={"./images/pages/profile/date-icon"}
                                />
                            </span>
                    ...
                    >
                        <div className={styles.followerInfo}>
                            <span
                                className={`subtext2 ${styles.followingCount}`}
                            >
                                1.6K{" "}
                            </span>
                            <span
                                className={`subtext1 ${styles.followingLabel}`}
                            >
                                Following
                            </span>
                            <span
                                className={`subtext2 ${styles.followerCount}`}
                            >
                                1.2M{" "}
                            </span>
                            <span
                                className={`subtext1 ${styles.followerLabel}`}
                            >
                                Followers
                            </span>
                        </div>
                    ...
                    {[...Array(5)].map((e, i) => {
                        return (
                            <Transition
                                ...
                                animationConfiguration={pageLoaderConfig}
                                entranceDelay={
                                    (10 + i) * pageLoaderConfig.delayFactor
                                }
