            ...
            <article className={styles.homePage}>
                ...
                >
                    <div className={styles.pageHeader}>
                        <h1 className={`headline2 ${styles.pageLabel}`}>
                            Latest Posts
                        </h1>
                ...
                >
                    <div className={styles.tweetComposer}>
                        ...
                        <div className={styles.wrapper}>
                            <span className={`headline1 ${styles.prompt}`}>
                                What's happening?
                            </span>
                            <div className={styles.ctas}>
                                <img
                                    className={styles.tweetOptions}
                                    src={TweetOptions}
                                />
                                <div className={`body ${styles.tweetCTA}`}>
                                    Post
                                </div>
                            </div>
                        </div>
                        ...
                        {[...Array(4)].map((e, i) => {
                            return (
                                <Transition
                                    ...
                                    animationConfiguration={pageLoaderConfig}
                                    entranceDelay={
                                        (2 + i) * pageLoaderConfig.delayFactor
                                    }
